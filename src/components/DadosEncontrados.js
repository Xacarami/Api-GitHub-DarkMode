        ...
        <div id={tema}>
          <div className="resumoPerfil" key={arrayCompleto.id}>
            ...
            <div className="logins">
              <a href={arrayCompleto.html_url} target="_blank" rel="noreferrer">
                <h2>{arrayCompleto.name}</h2>
              </a>
              <p>{arrayCompleto.bio}</p>
              <div className="divNick">
                <p className="nickGithub">
                  <a
                    href={arrayCompleto.html_url}
                    target="_blank"
                    rel="noreferrer"
                    className="nick"
                  >
